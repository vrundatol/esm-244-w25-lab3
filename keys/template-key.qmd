...
Now fill in the following code chunk to fit the random forest model. Create a table (or sometimes called a confusion matrix) that shows the predicted values versus the actual values.
